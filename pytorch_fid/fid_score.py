...
def compute_statistics_of_path(files, model, batch_size, dims, device, num_workers=1):
...
def calculate_fid_given_paths(files, batch_size, device, dims, num_workers=1,m2=None,s2=None):
    ...
    m1, s1 = compute_statistics_of_path(
        files[0], model, batch_size, dims, device, num_workers
    )
    if m2 is None:
        m2, s2 = compute_statistics_of_path(
            files[1], model, batch_size, dims, device, num_workers
        )
    else:
        pass
